...
export const About = () => {
  return (
    <div className="flex-1 bg-primary-100 border-2 border-quaternary-100 rounded-xl px-14 py-14">
      <div className="h-full w-full text-quinternary-100">
        ...
        <div className="flex items-center justify-between mt-20">
          ...
          <div className="w-40 h-40 bg-[#3F3E3E] rounded-full flex items-center justify-center">
            <Image
              src={animationImg}
              alt="animation"
              width={158}
