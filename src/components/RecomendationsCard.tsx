...
export const RecomendationsCard = () => {
  return (
    <div className='w-full h-80 bg-primary-100 rounded-xl border-2 border-quaternary-100 py-8 px-10'>
...
const Card = () => {
  ...
  return (
    <div className='h-48 w-[25rem] bg-tertiary-100 rounded-3xl text-white flex flex-col gap-5 justify-center px-5 py-5'>
